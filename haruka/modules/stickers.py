...
def stickerid(bot: Bot, update: Update):
    ...
    if msg.reply_to_message and msg.reply_to_message.sticker:
        ...
        update.effective_message.reply_text("Antworte auf einen Sticker, um seine ID zu erhalten.")
...
def getsticker(bot: Bot, update: Update):
    ...
    if msg.reply_to_message and msg.reply_to_message.sticker:
        ...
        update.effective_message.reply_text("Bitte antworte auf einen Sticker, den du als PNG haben möchtest.")
...
def kang(bot: Bot, update: Update, args: List[str]):
    ...
    if msg.reply_to_message:
        if msg.reply_to_message.sticker:
            ...
            msg.reply_text("Schade, den Sticker unterstütze ich nicht.")
        ...
        try:
            ...
            msg.reply_text(f"Sticker hinzugefügt zum [Pack](t.me/addstickers/{packname})" +
                            f"\nDer Emoji für diesen Sticker ist: {sticker_emoji}", parse_mode=ParseMode.MARKDOWN)
        except OSError as e:
            msg.reply_text("Halt Stop! Ich kann nur Fotos hinzufügen.")
            print(e)
            return
        except TelegramError as e:
            if e.message == "Stickerset_invalid":
                ...
                msg.reply_text("Sticker hinzugefügt zum [pack](t.me/addstickers/%s)" % packname + "\n"
                            "Der Emoji für diesen Sticker ist:" + " " + sticker_emoji, parse_mode=ParseMode.MARKDOWN)
            print(e)
    elif args:
        try:
