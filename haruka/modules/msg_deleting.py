...
def purge(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if msg.reply_to_message:
        ...
        if can_delete(chat, bot.id):
            ...
            for m_id in range(delete_to, message_id - 1, -1):  # Reverse iteration over message ids
                try:
                    ...
                    if err.message == "Ich kann diese Nachricht nicht löschen":
                        bot.send_message(chat.id, "Überprüfe bitte,  "
                                                  "dass ich Nachrichten löschen kann")

                    elif err.message != "Nachricht, die gelöscht werden soll, nicht gefunden":
        ...
        msg.reply_text("Wie bitte? Von welcher Nachricht aus soll ich alles löschen?")
...
def del_message(bot: Bot, update: Update) -> str:
    if update.effective_message.reply_to_message:
        ...
        update.effective_message.reply_text("Was möchtest du löschen?")

    return ""


__help__ = """
Mit diesem Befehl ist Nachrichten löschen ganz einfach.

*Nur für Admins:*
 - /del: Löscht die Nachricht, auf die du antwortest.
 - /purge: Löscht alle Nachrichten zwischen dieser, und der, auf die du antwortest.
"""

__mod_name__ = "Nachrichten löschen"
